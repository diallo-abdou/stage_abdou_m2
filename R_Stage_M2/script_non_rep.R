...
ZAA_HR_select = data.frame(Programme = rep("ZAA_HR"), ID =ZAA_HR$ID )
...
levels(bdd_clean_mini$clcm_lvl3)[levels(bdd_clean_mini$clcm_lvl3) == "Broad-leaved forest"] <- "Mixed forest"
