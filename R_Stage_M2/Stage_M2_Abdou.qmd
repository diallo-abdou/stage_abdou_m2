...
write.csv2(x =bdd_all,file = "datas/Non_repeated_data/bdd_all.csv", row.names = FALSE)
```
...
Explorations de l'occurence des espèces

Exploration des relations entre les espèces et les predicteurs

ACP sur les predicteurs de l'abondance, la biomasse et la richesse
...
acp_AB_tot <- PCA(df_acp_AB_tot, graph = FALSE,quanti.sup=1,quali.sup=2)
...
Zero duplicates in GPS and ID_Site
