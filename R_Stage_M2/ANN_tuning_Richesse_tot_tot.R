...
# Data
training = read.csv2("datas/Richesse_tot_train.csv")
test = read.csv2("datas/Richesse_tot_test.csv")

df_tot = rbind(training,test)
...
richness_dist_train_and_test= ggplot(df, aes(x=y, fill=set)) +
  ...
  theme_gray() +
  theme(plot.title = element_text(hjust = 0.5))
ggsave("Results/richness_dist_train_and_test.png", plot = richness_dist_train_and_test, dpi = 300)
richness_dist_train_and_test
...
runs = read.csv2("results_tuning/Richesse_tot_ANN_tuning.csv")
...
# Visualisation du best ANN Richesse_tot ----------------------------------------

df_ANN_Richesse_tot = rbind(ANN_1_results,ANN_tune_results,ANN_2_results,ANN_3_results,ANN_4_results)


df_ANN_Richesse_tot = df_ANN_Richesse_tot %>% arrange(mae)
df_ANN_Richesse_tot[1,1]

#best_ANN_Richesse_tot = as.name(df_ANN_Richesse_tot[1,1])

# Save the entire model as a SavedModel.
save_model_tf(as.name(df_ANN_Richesse_tot[1,1]), "models/best_ANN_Richesse_tot")
# my_model directory
# Contains an assets folder, models.pb, and variables folder.
#fs::dir_tree("models/")

best_ANN_Richesse_tot <- load_model_tf('models/best_ANN_Richesse_tot')

# Check its architecture
summary(best_ANN_Richesse_tot)
...
n <- neuralnet(Richesse_tot~ CaCO3+gps_x+bio7+bio4+N+bio3+CN+gps_y+elevation+P+bio15+bio18+
...
plot(n, rep="best")
#ggsave("Results/richness_ANN.png", plot = richness_ANN, dpi = 300)
