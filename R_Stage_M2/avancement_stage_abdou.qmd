...
new_cl <- c("blf", "cf", "gua", "mf", "ng", "nial", "p", "v")
...
Elevation est corrélé a gps_x mais on garde les deux pour le moment.
...
climat_sup=c("bio2","bio4","bio5","bio6","bio7","bio10","bio11","bio13","bio16","bio17","bio18","bio19","gdd0","gdd10", "cmi_mean")
```
...
var=c("elevation","pH","silt","clay","C","P","N","K","CN","CEC","CaCO3","bio1","bio3","bio8","bio9",
      "bio12","bio14","bio15","hurs_mean","PET")
# 
...
bdd_explo <- bdd_explo[, setdiff(names(bdd_explo), c("gps_x","gps_y"))]
```
...
var=c("elevation","pH","silt","clay","C","P","N","K","CN","CEC","CaCO3","bio1","bio3","bio8","bio9",
      "bio12","bio14","bio15","hurs_mean", "PET")
#usdm::vif(bdd_explo[,var])
#usdm::vifcor(bdd_explo[,var], th = 0.9, keep = NULL, method = 'pearson')
usdm::vifstep(bdd_explo[,var], th = 10, keep = NULL, method = 'pearson')
...
# usdm::vifstep(bdd_explo[,10:36], th = 10, keep = NULL, method = 'pearson')
# usdm::vif(bdd_explo[,10:36])
# usdm::vifcor(bdd_explo[,10:36], th = 0.9, keep = NULL, method = 'pearson')
...
var=c("elevation","pH","silt","clay","C","P","N","K","CN","CEC","CaCO3","bio1","bio3","bio8","bio9","bio12","bio15","hurs_mean", "PET")
